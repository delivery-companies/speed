import { useSendResponse } from "@/hooks/useTicket";
...
export const SendResponse = ({ id, close, opened }: Props) => {
    const { mutate: sendResponse, isLoading } = useSendResponse();
    ...
    return (
        <Modal opened={opened} onClose={handleClose} title="ارسال رد" centered>
