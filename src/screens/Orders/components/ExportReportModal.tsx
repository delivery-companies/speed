...
import { useExportOrders, useOrderReceipt } from "@/hooks/useOrderReceipt";
import { useTenants } from "@/hooks/useTenants";
import {
  type governorateArabicNames,
  governorateArray,
...
export const ExportReportModal = () => {
  ...
  const { mutateAsync: exportExcel } = useExportOrders();
  ...
  const handleExport = async () => {
    toast.promise(
      ...
      {
        loading: "جاري تصدير الملف",
        success: "تم تصدير ملف الاكسيل بنجاح",
    ...
    <>
      ...
      <Menu shadow="md" width={200}>
        ...
        <Menu.Dropdown>
          ...
          <Menu.Item onClick={handleExport}>اكسيل</Menu.Item>
        </Menu.Dropdown>
      </Menu>
    </>
  );
